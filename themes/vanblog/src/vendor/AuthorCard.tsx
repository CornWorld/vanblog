/* UPSTREAM: packages/website/components/AuthorCard/index.tsx@4b488500be8100b19772ec00d8315f343a6ac21e
 * SEAM: ThemeContext → html.dark 桥;next/link → <a> + withBase;SocialCard/ImageBox
 * 为本目录 vendor 版。上游 fix → apply patch。
 */
...
export default function (props: { option: AuthorCardProps }) {
  ...
  // SEAM: ThemeContext → html.dark + 平台 darkmodechange 事件桥(与 Reward 同法)。
