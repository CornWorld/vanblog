/* UPSTREAM: packages/website/components/SocialIcon/index.tsx@4b488500be8100b19772ec00d8315f343a6ac21e
 * SEAM: ThemeContext → html.dark 桥;SocialItem → seams/social;其余逐字。上游 fix → apply patch。
 */
