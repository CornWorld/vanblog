/* UPSTREAM: packages/website/components/TimeLineItem/index.tsx@4b488500be8100b19772ec00d8315f343a6ac21e
 * SEAM: Article 类型内联(id/title/createdAt/path);ArticleList → 本目录 vendor 版
 * (SearchHit:path 由调用方以 pathname 映射)。上游 fix → apply patch。
 */
...
export default function (props: {
  date: string;
  articles: { id: string; title: string; createdAt?: string; path?: string }[];
  defaultOpen?: boolean;
  showYear?: boolean;
