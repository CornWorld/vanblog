/* UPSTREAM: packages/website/components/SocialCard/index.tsx@4b488500be8100b19772ec00d8315f343a6ac21e
 * SEAM: SocialItem → seams/social;其余逐字。上游 fix → apply patch。
 */
import { useEffect, useState } from "react";
import type { SocialItem } from "./seams/social";
...
export default function (props: { socials: SocialItem[] }) {
  ...
  const renderEach = (item: SocialItem) => {
    ...
    return (
      <div
        className="w-1/2 mb-1  mx-1 flex items-center rounded-xs transition-all text-xs text-gray-500 dark:text-dark group  hover:bg-gray-200 dark:hover:bg-dark-light dark:hover:text-dark-r select-none cursor-pointer"
        style={{ padding: "2px 0" }}
      >
