/* UPSTREAM: packages/website/components/AdminButton/index.tsx@4b488500be8100b19772ec00d8315f343a6ac21e
 * SEAM: 无(原样;/admin 为平台控制面板路径,与平台一致)。上游 fix → 对本文件 apply patch。
 */
