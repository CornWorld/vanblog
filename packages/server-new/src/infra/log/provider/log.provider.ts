...
import { getNetIp, getPlatform } from '../utils/utils';
import lineReader from 'line-reader';
import { config } from 'src/common/config';
import path from 'path';
import { checkOrCreate } from 'src/common/utils/checkFolder';
import { Pipeline } from 'src/scheme/pipeline.schema';
import { CodeResult } from 'src/service/contentManagement/provider/pipeline.provider';
@Injectable()
