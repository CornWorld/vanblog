...
import type {
  ActionCallback,
  FilterCallback,
} from '../../modules/plugin/interfaces/hook.interface';
import type { PluginContext } from '../../modules/plugin/interfaces/plugin-context.interface';
import type { Plugin } from '../../modules/plugin/services/plugin-loader.service';
