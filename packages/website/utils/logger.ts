/**
 * Logger utility for website package
...
class Logger {
  ...
  constructor(context: string, config?: Partial<LoggerConfig>) {
    ...
    this.config = {
      ...
      enableColor: this.isServer, // Only enable colors in server-side
      ...config,
    };
  }
 ...
 * @param context - Context identifier (e.g., 'getPageProps', 'Layout', 'API')
