...
const getRewriteRules = () => {
  ...
  console.log(
    '- VAN_BLOG_WALINE_URL:',
    process.env.VAN_BLOG_WALINE_URL || 'http://127.0.0.1:8360/comment (default)',
  );
  console.log(
    '- VAN_BLOG_SERVER_URL:',
    process.env.VAN_BLOG_SERVER_URL || 'http://127.0.0.1:3000 (default)',
  );
  console.log(
    '- NEXT_PUBLIC_VANBLOG_SERVER_URL:',
