...
export default function Layout(props: {
  ...
  return (
    <>
      ...
      {props.option.baiduAnalysisID != '' && process.env.NODE_ENV != 'development' && (
        <BaiduAnalysis id={props.option.baiduAnalysisID}></BaiduAnalysis>
      )}

      {props.option.gaAnalysisID != '' && process.env.NODE_ENV != 'development' && (
      ...
      >
        ...
        {/* <ImageProvider> */}
        <NavBar
          openArticleLinksInNewWindow={props.option.openArticleLinksInNewWindow == 'true'}
