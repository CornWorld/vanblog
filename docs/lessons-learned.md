...
| 项目                     | 状态                                | 风险                                                                                                                                                                                                                                                                                                                                                                                                              |
| ------------------------ | ----------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Astro 前端               | 已实现（2026-07-02）                | 博客前端：首页、文章页（SSR）、归档、搜索、时间线、分类/标签页；管理后台：11 个 admin 页面（文章编辑、用户管理、路由配置、审计日志等）、登录页、setup 引导页。调色盘/主题系统待后续完善（暗色模式已修复）。                                                                                                                                                                                                       |
...
| ~~Waline 集成~~          | 已替换为 Artalk (2026-07-05)        | 改用 Artalk（Go+SQLite，~30MB，Artransfer-CLI 可迁移 Waline 数据）                                                                                                                                                                                                                                                                                                                                                |
